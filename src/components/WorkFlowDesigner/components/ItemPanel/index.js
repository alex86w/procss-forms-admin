    ...
    <div ref={ref} className={styles.itemPanel} style={{ height }}>
      <Collapse bordered={false} defaultActiveKey={[]}>
        ...
        <Panel header={i18n['task']} key="2" forceRender>
          <img
            data-item={
              "{clazz:'userTask',size:'80*44',label:'" + i18n['userTask'] + "'}"
            }
          ...
          <img
            data-item="{clazz:'subProcess',size:'80*44',label:''}"
            src={require('../../assets/flow/sub-process.svg')}
            style={{ width: 80, height: 44 }}
          />
          ...
          <img
            data-item={
              "{clazz:'javaTask',size:'80*44',label:'" + i18n['javaTask'] + "'}"
            }
          ...
          <img
            data-item={
              "{clazz:'mailTask',size:'80*44',label:'" + i18n['mailTask'] + "'}"
            }
